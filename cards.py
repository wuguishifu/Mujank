...
cards = [
    ...
    ['c_id_0360', "bo- fingernails.jpg", "Yup that's me", 3, "Bo"],
    ['c_id_0361', "bo- gas_mask.jpg", "Gas Mask Bo", 3, "Bo"],
    ['c_id_0362', "bo- joe_bo.jpeg", "Joe Bo", 3, "Bo"],
    ['c_id_0363', "bo- labcoat_two.jpg", "Labcoat Bo", 3, "Bo"],
    ['c_id_0364', "combo- 3girls.png", "Girls on the Shore", 3, "Combo"],
    ['c_id_0365', "combo- 2019.JPG", "2019", 3, "Combo"],
    ['c_id_0366', "combo- chillin_like_villians.jpeg", "Chillin' Like Villians", 3, "Combo"],
    ['c_id_0367', "combo- flynn_bitmoji.JPG", "Flynn's Bitmoji and Friends", 3, "Combo"],
    ['c_id_0368', "combo- formal_hipster_besties.JPG", "Hipsters", 3, "Combo"],
    ['c_id_0369', "combo- grad_sheesh.jpeg", "Sheesh Zot", 3, "Combo"],
    ['c_id_0370', "combo- grouped_up.jpeg", "Grouped Up", 3, "Combo"],
    ['c_id_0371', "combo- hackathon.jpeg", "Hackthon Picture", 3, "Combo"],
    ['c_id_0372', "combo- halloween.png", "Halloween Hype", 3, "Combo"],
    ['c_id_0373', "combo- janksgiving_feast.jpeg", "Janksgiving Feast", 3, "Combo"],
    ['c_id_0374', "combo- matt_nina_joes.jpg", "3-pronged Italian Ice", 3, "Combo"],
    ['c_id_0375', "combo- mikey_sushi_wow.jpeg", "WOW Sushi!", 3, "Combo"],
    ['c_id_0376', "combo- Milk_T.JPG", "Milk+T", 3, "Combo"],
    ['c_id_0377', "combo- moorpark_grad_buddies.JPG", "Moorpark Graduation Pals", 3, "Combo"],
    ['c_id_0378', "combo- moorpark_peace.jpeg", "Peace Out - from Moorparkians", 3, "Combo"],
    ['c_id_0379', "combo- oh_look_a_loser.jpeg", "Oh Look, it's a Loser!", 3, "Combo"],
    ['c_id_0380', "combo- paint.png", "Made With Love", 3, "Combo"],
    ['c_id_0381', "combo- peace_from_camino.jpeg", "Having Fun", 3, "Combo"],
    ['c_id_0382', "combo- poster_hanging.jpeg", "Poster Hanging", 3, "Combo"],
    ['c_id_0383', "combo- prepare_for_trouble.JPG", "Prepare for Trouble", 3, "Combo"],
    ['c_id_0384', "combo- sad_in_the_dark.JPG", "Sad in the Dark", 3, "Combo"],
    ['c_id_0385', "combo- shame.jpeg", "Shame Squat", 3, "Combo"],
    ['c_id_0386', "combo- shocked.JPG", "Shocking", 3, "Combo"],
    ['c_id_0387', "combo- steven_and_steven.jpg", "Steven and Steven", 3, "Combo"],
    ['c_id_0388', "combo- sup_my_homies.jpeg", "Wassup my Homies", 3, "Combo"],
    ['c_id_0389', "combo- technostevefriends.jpeg", "Techno Steve & Friends", 3, "Combo"],
    ['c_id_0390', "combo- tommymatt.jpeg", "Tommy and Matt hate COVID", 3, "Combo"],
    ['c_id_0391', "combo- teo_little_piggies.JPG", "Two Little Piggies", 3, "Combo"],
    ['c_id_0392', "combo- universal_line.jpeg", "Universal Family", 3, "Combo"],
    ['c_id_0393', "combo- will_tommy_ghost.JPG", "Boo!", 3, "Combo"],
    ['c_id_0394', "elijah- american_eagle.JPG", "Elijah!", 3, "Elijah"],
    ['c_id_0395', "haroon- raccoon_haroon.jpeg", "Raccoon Haroon", 3, "Haroon"],
    ['c_id_0396', "haroon- tuxedo.jpg", "Tuxedo Haroon", 3, "Haroon"],
    ['c_id_0397', "matt- you_better_love_frank_ocean.PNG", "You'd better love Frank Ocean", 3, "Matt"],
    ['c_id_0398', "nina- interested.jpg", "Interesting Post", 3, "Nina"],
    ['c_id_0399', "noah- rosie_riveter.png", "Noah Riveter", 3, "Noah"],
    ['c_id_0400', "steven- backwards_hat.jpeg", "Backwards Hat Steven", 3, "Steven"],
    ['c_id_0401', "steven- griddle_chef.jpeg", "Griddle Chef Steven", 3, "Steven"],
    ['c_id_0402', "steven- im_a_ninja.jpeg", "I'm a ninja", 3, "Steven"],
    ['c_id_0403', "steven- ringring.jpeg", "Ring Ring", 3, "Steven"],
    ['c_id_0404', "steven- roses_are_red.jpeg", "Roses are Red", 3, "Steven"],
    ['c_id_0405', "steven- scared.jpeg", "Spooked", 3, "Steven"],
    ['c_id_0406', "steven- spam_musubi.jpeg", "Spam Musubi Making", 3, "Steven"],
    ['c_id_0407', "steven- techno.jpeg", "Techno Steve", 3, "Steven"],
    ['c_id_0408', "bo- balloon_swords.jpg", "Genji Bo", 4, "Bo"],
    ['c_id_0409', "combo- are_you_ok.png", "Nina, are you okay?", 4, "Combo"],
    ['c_id_0410', "combo- disgusted.png", "Disgusted with this Shit", 4, "Combo"],
    ['c_id_0411', "combo- dog_ritual.jpeg", "Dog Ritual", 4, "Combo"],
    ['c_id_0412', "combo- get_away_from_me.png", "Get Away From Me", 4, "Combo"],
    ['c_id_0413', "combo- i_dont_wanna_get_lost.png", "I Don't Wanna Get Lost", 4, "Combo"],
    ['c_id_0414', "combo- laugh_hurts.JPG", "Laughing Hurts", 4, "Combo"],
    ['c_id_0415', "combo- mikey_flynn_nerf_buddies.jpg", "Double O Seven", 4, "Combo"],
    ['c_id_0416', "combo- spikeball.jpeg", "Spikeball", 4, "Combo"],
    ['c_id_0417', "elijah- elijah_stand.png", "Elijah Stand", 4, "Elijah"],
    ['c_id_0418', "haroon- feating_kbbq.jpeg", "KBBQ Feasting", 4, "Haroon"],
    ['c_id_0419', "haroon- makeup.JPG", "Makeup Haroon", 4, "Haroon"],
    ['c_id_0420', "matt- female_matt.png", "Female Matt", 4, "Matt"],
    ['c_id_0421', "matt- good_morning.jpg", "Good Morning", 4, "Matt"],
    ['c_id_0422', "nayoung- clout_game_strong.jpg", "Clout", 4, "Nayoung"],
    ['c_id_0423', "nina- lunch_break.png", "Lunch Break", 4, "Nina"],
    ['c_id_0424', "steven- cars_ride.JPG", "Vroom", 4, "Steven"],
    ['c_id_0425', "steven- female_steven.png", "Stephanie", 4, "Steven"],
    ['c_id_0426', "steven- pool_shitting.jpg", "Shitting in the Pool", 4, "Steven"],
    ['c_id_0427', "tommy- pumpkin_stack.jpg", "Pumpkin Stack", 4, "Tommy"],
    ['c_id_0428', "will- furry_club.JPG", "Furry Club Will", 4, "Will"],
    ['c_id_0429', "will- tuba.jpg", "Tuba Will", 4, "Will"],
    ['c_id_0430', "haroon- big_dick_haroon.jpeg", "Big Dick Haroon", 5, "Haroon"],
    ['c_id_0431', "john- sandy_ass.jpeg", "Sandy Ass John", 5, "John"],
    ['c_id_0432', "nina- kayak.jpg", "Kayaking Nina", 5, "Nina"],
]
